...
from exodus_metaphor.plotting import write_scatter_3d_html
...
def main():
    ...
    points = PCA(n_components=3, random_state=args.seed).fit_transform(embeddings)
    output = write_scatter_3d_html(
        points,
        labels,
        texts,
        args.output,
