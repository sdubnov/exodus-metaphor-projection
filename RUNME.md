...
Sample-demo caption: The unguided embedding baseline tends to separate the synthetic passages by genre and surface vocabulary: narrative, philosophical, civic, and unrelated control passages form different clouds. The anchor-guided metaphor projection then reorganizes the narrative, philosophical, and civic passages around shared Exodus/liberty concerns such as coercion, departure, law, covenant, agency, and collective future. In the sample demo, passages with low similarity to the curated anchor phrases receive a smooth downward offset, so the unrelated control text, shown in red, is visually separated without imposing hard horizontal bands.
